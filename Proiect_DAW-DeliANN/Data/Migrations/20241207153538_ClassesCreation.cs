...
{
    /// <inheritdoc />
    public partial class ClassesCreation : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "ApplicationUserWorkspaces",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationUserWorkspaces", x => new { x.Id, x.UserId, x.WorkspaceId });
                    table.ForeignKey(
                        name: "FK_ApplicationUserWorkspaces_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ApplicationUserWorkspaces_Workspaces_WorkspaceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUserWorkspaces_UserId",
                table: "ApplicationUserWorkspaces",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUserWorkspaces_WorkspaceId",
                table: "ApplicationUserWorkspaces",
                column: "WorkspaceId");
